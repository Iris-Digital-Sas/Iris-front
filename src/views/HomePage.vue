        ...
        <div class="home-contact-bloc">
            <div class="home-contact-bloc-text">
                ...
                <div class="home-contact-bloc-text_email">
                    <img src="email-min.png" alt="email"><span>hello@irisdigital.fr</span>
                </div>
            </div>
            <form action="">
