<template>
    <div class="page-tarifs">
        <section class="bgc-dark-blue title-prices">
            ...
            <span class="prices_info_mobile">Retrouvez le symbole <img class="ai-icon-spoiler" :src="`${publicPath}AI-original-min.png`" alt="">  pour les solutions intégrant de l'IA</span>    
        </section>
        <section class="prices" id="wd">
            <div class="prices_info bgc-dark-blue">Retrouvez le symbole <img class="ai-icon-spoiler" :src="`${publicPath}AI-original-min.png`" alt="">  pour les solutions intégrant de l'IA</div>
            ...
            <Carousel>
                ...
                <Slide :key="slide">
                    <div class="formula">
                        <div class="ai-icon"><img class="ai-icon" :src="`${publicPath}AI-symbol-min.png`" alt=""></div>
